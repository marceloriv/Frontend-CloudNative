    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
        <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full p-6 flex flex-col items-center gap-4">
          ...
          <p className="font-mono text-base font-bold text-text tracking-widest">{createdVisita.codigo}</p>
          <p className="text-muted text-xs text-center">
            Comparte este código con tu visita. La conserjería lo validará en el acceso.
          </p>
          <div className="flex gap-3 w-full mt-2">
...
const LOG_ENTRIES: LogEntry[] = [
  { hora: '08:32', visitante: 'María González', unidad: 'Torre B · 304', accion: 'Entrada', estado: 'en_progreso' },
  { hora: '09:15', visitante: 'Delivery Cornershop', unidad: 'Torre A · 802', accion: 'Entrada', estado: 'completada' },
  { hora: '09:47', visitante: 'Delivery Cornershop', unidad: 'Torre A · 802', accion: 'Salida', estado: 'completada' },
  { hora: '10:03', visitante: 'Pedro Soto', unidad: 'Torre C · 101', accion: 'Entrada', estado: 'en_progreso' },
  { hora: '11:22', visitante: 'Técnico VTR', unidad: 'Torre A · 1204', accion: 'Entrada', estado: 'en_progreso' },
]
            ...
            <thead className="bg-gray-50 border-b border-border">
              <tr>
                {['Hora', 'Visitante', 'Unidad', 'Acción', 'Estado'].map((col) => (
                  <th key={col} className="text-left px-4 py-3 text-muted font-semibold text-xs uppercase tracking-wide">
                    {col}
                  </th>
                ))}
              </tr>
              ...
              {LOG_ENTRIES.map((entry, i) => (
                <tr key={i} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <span className={`font-semibold ${entry.accion === 'Entrada' ? 'text-primary' : 'text-muted'}`}>
