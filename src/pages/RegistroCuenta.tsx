            ...
            <div>
              ...
              >
                <p className="font-semibold text-text mb-2">
                  Reglamento Interno — Torres del Parque
                </p>
                {[
                  [
                    "1. Horarios de silencio.",
                    "Entre 22:00 y 08:00 hrs no se permitirán ruidos que perturben el descanso de los residentes.",
                  ],
                  [
                    "2. Espacios comunes.",
                    "Deben reservarse con anticipación en la plataforma. El uso sin reserva vigente está prohibido.",
                  ],
                  [
                    "3. Mascotas.",
                    "Deben transitar con correa en áreas comunes. Los dueños son responsables en todo momento.",
                  ],
                  [
                    "4. Estacionamientos.",
